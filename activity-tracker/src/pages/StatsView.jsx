    ...
    <main className="max-w-5xl mx-auto px-8 py-8 flex flex-col gap-8 w-full animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white p-6 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-[#F4EFE6] flex flex-col gap-2 relative overflow-hidden">
          ...
          <h3 className="text-3xl font-semibold">69<span className="text-xl text-[#8C7A6B] font-medium">h</span></h3>
        </div>
        <div className="bg-white p-6 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-[#F4EFE6] flex flex-col gap-2 relative overflow-hidden">
          <div className="p-3 bg-[#FAF8F5] rounded-xl text-[#8C7A6B] w-max mb-2">
            <Target size={24} />
          </div>
          <p className="text-sm text-[#8C7A6B] font-medium">Completion Rate</p>
          <h3 className="text-3xl font-semibold">85<span className="text-xl text-[#8C7A6B] font-medium">%</span></h3>
        </div>
        <div className="bg-white p-6 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-[#F4EFE6] flex flex-col gap-2 relative overflow-hidden">
          <div className="p-3 bg-[#FAF8F5] rounded-xl text-[#8C7A6B] w-max mb-2">
            <Award size={24} />
          </div>
          <p className="text-sm text-[#8C7A6B] font-medium">Best Month</p>
          <h3 className="text-3xl font-semibold">March</h3>
        </div>
      </div>
